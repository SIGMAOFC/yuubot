...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `✳️ Responde a uma imagem ou vídeo com*${usedPrefix + command}*`
      let out
      try {
    ...
    else throw 'A conversão falhou, tenta enviar primeiro * imagem/vídeo/gif * e depois responder com o comando'
  }
}
