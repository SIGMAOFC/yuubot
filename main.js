...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = 'tchau @user'
  conn.spromote = '@user Admin promovido'
  conn.sdemote = '@user   Foi Rebaixado'
  conn.sDesc = 'A descrição foi alterada para \n@desc'
  conn.sSubject = 'O nome do grupo foi alterado para \n@subject'
  conn.sIcon = 'O ícone do grupo foi alterado.'
  conn.sRevoke = 'O link do grupo foi alterado para \n@revoke'
